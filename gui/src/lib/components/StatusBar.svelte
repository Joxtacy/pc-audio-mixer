...
<div class="status-bar">
    ...
    <div class="status-controls">
        {#if status.connected}
            <button class="btn btn-disconnect" on:click={handleDisconnect}>
                Disconnect
            </button>
            <button class="btn btn-reconnect" on:click={handleReconnect}>
                Reconnect
            </button>
        {:else}
            <button
            ...
            <button class="btn btn-select" on:click={togglePortSelector}>
                Select Port
            </button>
        {/if}
    </div>
    ...
    {#if showPortSelector && !status.connected}
        <div class="port-selector">
            ...
            {:else}
                ...
                <button class="btn" on:click={listSerialPorts}>
                    Refresh
                </button>
            {/if}
        </div>
